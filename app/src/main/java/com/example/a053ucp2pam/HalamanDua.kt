...
fun HalamanDua(
    ...
    var listData : MutableList<String> = mutableListOf(nama, nim, konsentrasi, judul, dospem1,dospem2)
    Column (
        ...
        Column(
            ...
            OutlinedCard(
                ...
                Column(
                    ...
                    Button(modifier = Modifier.fillMaxWidth(),onClick = { onSubmitClicked(listData) },
